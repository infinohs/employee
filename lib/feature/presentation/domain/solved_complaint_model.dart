import 'dart:convert';
SolvedComplaintModel solvedComplaintModelFromJson(String str) => SolvedComplaintModel.fromJson(json.decode(str));
String solvedComplaintModelToJson(SolvedComplaintModel data) => json.encode(data.toJson());
class SolvedComplaintModel {
  SolvedComplaintModel({
      List<Completed>? completed,}){
    _completed = completed;
}

  SolvedComplaintModel.fromJson(dynamic json) {
    if (json['completed'] != null) {
      _completed = [];
      json['completed'].forEach((v) {
        _completed?.add(Completed.fromJson(v));
      });
    }
  }
  List<Completed>? _completed;

  List<Completed>? get completed => _completed;
