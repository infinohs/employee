import 'dart:convert';
PendingComplaintModel pendingComplaintModelFromJson(String str) => PendingComplaintModel.fromJson(json.decode(str));
String pendingComplaintModelToJson(PendingComplaintModel data) => json.encode(data.toJson());
class PendingComplaintModel {
  ...
  PendingComplaintModel.fromJson(dynamic json) {
